...
namespace CizaTable
{
	public abstract class BTable
	{
		...
		//constructor
		protected BTable() : this(KeyLetterTypes.Normal) { }

		protected BTable(KeyLetterTypes keyLetterType) =>
			KeyLetterType = keyLetterType;

		//public method
		public abstract void Initialize(IDataUnit[] dataUnits);
		public abstract void Release();

		public abstract bool TryGetKeys(out string[] keys);
	}

	public abstract class BTable<TTableData> : BTable where TTableData : TableData
	{
		//private variable
		...
		//public method
		public override void Initialize(IDataUnit[] dataUnits)
		{
			if (IsInitialized)
				return;
		...
		public override bool TryGetKeys(out string[] keys)
		{
			if (!IsInitialized)
			{
